...
class _DashboardViewState extends State<DashboardView> {
  ...
  void initState() {
    super.initState();
    _controller = Get.put(DashboardController(service: getIt<AttendanceLocalService>()));
  }
    ...
    return Scaffold(
      body: SafeArea(
        child: RefreshIndicator(
          ...
          onRefresh: () => _controller.getAttendances(isRefresh: true),
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    (today?.checkIn).getText(defaultValue: "--:--"),
                                                    style: AppTextStyles.bodyLarge.copyWith(
                                                      fontWeight: AppTextStyles.bold,
                                                    ),
                                                  ),
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    (today?.checkOut).getText(defaultValue: "--:--"),
                                                    style: AppTextStyles.bodyLarge.copyWith(
                                                      fontWeight: AppTextStyles.bold,
                                                    ),
                                                  ),
